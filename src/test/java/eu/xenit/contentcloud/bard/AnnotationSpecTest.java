...
public final class AnnotationSpecTest {
  ...
  @Test public void defaultAnnotation() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "import eu.xenit.contentcloud.bard.AnnotationSpecTest;\n"
  ...
  @Test public void defaultAnnotationWithImport() {
    ...
    JavaFile file = JavaFile.builder("eu.xenit.contentcloud.bard", typeBuilder.build()).build();
  ...
  @Test public void emptyArray() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@eu.xenit.contentcloud.bard.AnnotationSpecTest.HasDefaultsAnnotation(" + "n = {}" + ")");
    builder.addMember("m", "$L", "{}");
    assertThat(builder.build().toString())
        .isEqualTo(
            "@eu.xenit.contentcloud.bard.AnnotationSpecTest.HasDefaultsAnnotation("
                + "n = {}, m = {}"
                + ")");
  }
  ...
  @Test public void dynamicArrayOfEnumConstants() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@eu.xenit.contentcloud.bard.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = eu.xenit.contentcloud.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + ")");
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@eu.xenit.contentcloud.bard.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = {"
            + "eu.xenit.contentcloud.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", eu.xenit.contentcloud.bard.AnnotationSpecTest.Breakfast.WAFFLES"
            + ", eu.xenit.contentcloud.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + "})");
  ...
  @Test public void defaultAnnotationToBuilder() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@eu.xenit.contentcloud.bard.AnnotationSpecTest.HasDefaultsAnnotation("
            + "o = eu.xenit.contentcloud.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", p = 1701"
            + ", f = 11.1"
            + ", m = {9, 8, 1, 123}"
            + ", l = java.lang.Override.class"
            + ", j = @eu.xenit.contentcloud.bard.AnnotationSpecTest.AnnotationA"
            + ", q = @eu.xenit.contentcloud.bard.AnnotationSpecTest.AnnotationC(\"bar\")"
