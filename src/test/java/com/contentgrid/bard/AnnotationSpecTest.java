...
public final class AnnotationSpecTest {
  ...
  @Test public void defaultAnnotation() {
    ...
    assertThat(toString(taco)).isEqualTo(""
        ...
        + "\n"
        + "import com.contentgrid.bard.AnnotationSpecTest;\n"
  ...
  @Test public void defaultAnnotationWithImport() {
    ...
    JavaFile file = JavaFile.builder("com.contentgrid.bard", typeBuilder.build()).build();
  ...
  @Test public void emptyArray() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.contentgrid.bard.AnnotationSpecTest.HasDefaultsAnnotation(" + "n = {}" + ")");
    builder.addMember("m", "$L", "{}");
    assertThat(builder.build().toString())
        .isEqualTo(
            "@com.contentgrid.bard.AnnotationSpecTest.HasDefaultsAnnotation("
                + "n = {}, m = {}"
                + ")");
  }
  ...
  @Test public void dynamicArrayOfEnumConstants() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.contentgrid.bard.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = com.contentgrid.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + ")");
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.contentgrid.bard.AnnotationSpecTest.HasDefaultsAnnotation("
            + "n = {"
            + "com.contentgrid.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", com.contentgrid.bard.AnnotationSpecTest.Breakfast.WAFFLES"
            + ", com.contentgrid.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + "})");
  ...
  @Test public void defaultAnnotationToBuilder() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
        "@com.contentgrid.bard.AnnotationSpecTest.HasDefaultsAnnotation("
            + "o = com.contentgrid.bard.AnnotationSpecTest.Breakfast.PANCAKES"
            + ", p = 1701"
            + ", f = 11.1"
            + ", m = {9, 8, 1, 123}"
            + ", l = java.lang.Override.class"
            + ", j = @com.contentgrid.bard.AnnotationSpecTest.AnnotationA"
            + ", q = @com.contentgrid.bard.AnnotationSpecTest.AnnotationC(\"bar\")"
  ...
  @Test public void arrayOfAnnotations() {
    ...
    assertThat(builder.build().toString()).isEqualTo(
            "@com.contentgrid.bard.AnnotationSpecTest.HasSubAnnotations({\n"
                    + "    @com.contentgrid.bard.AnnotationSpecTest.SubAnnotation(name = \"bar\"),\n"
                    + "    @com.contentgrid.bard.AnnotationSpecTest.SubAnnotation(name = \"baz\"),\n"
                    + "    @com.contentgrid.bard.AnnotationSpecTest.SubAnnotation(name = \"baq\")\n"
                    + "})");
  }
}
